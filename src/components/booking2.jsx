        ...
        <form
          ...
          <div className="relative mb-4">
            <label
              ...
              Please describe your idea, the size, placement, if it’s color or black and gray and your budget. Include any visual reference you may have. If you don’t have any, that’s fine.
            </label>
            <textarea
              id="message"
              name="message"
